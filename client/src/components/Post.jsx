...
function Post(props) { 
     ...
     return (
          <>
               <button onClick={props.onOpen} className="bg-white cursor-pointer p-[10px] w-fit h-fit flex flex-col gap-[10px] rounded-[10px] shadow-[0_0_20px_rgba(10,10,10,0.1)]">
