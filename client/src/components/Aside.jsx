...
function Aside() {
  ...
  return (
    <aside className='flex flex-col p-[20px] shadow-[0_0_60px_rgba(0,0,0,0.10)] z-50 gap-[30px]'>
      ...
      <div className="flex flex-col justify-between flex-1">
          <div>
               <ul className="flex flex-col gap-[10px]">
                    ...
                    <li>
                         <LinkIcon icon={<IconSpeakerphone size={18} />} text={"Anunciar"} path={"/"} />
                    </li>
               </ul>
          </div>    
          <div className='bg-element-bg p-[10px] rounded-[8px]'>
               {user && <Link className="w-fit flex gap-[10px] items-center">
                    <img src="/images/user-placeholder-image.png" className='w-[30px] h-[30px] rounded-[8px]' />
                    <span className="max-w-[100px]">Username</span>
               </Link>}
          </div>
      </div>
    </aside>
